...
//images
import vueMkHeader from "@/assets/img/principal.gif";
        ...
        <div class="row">
          <div class="col-lg-7 text-center mx-auto position-relative">
            ...
            <p class="lead text-white px-5 mt-3" :style="{ fontWeight: '500' }">
              Nosotros construimos espacios residenciales a través de una combinación única de tecnología, 
              experiencia y diseño. La integración de estas tres áreas puede marcar la diferencia en la calidad 
              y la funcionalidad de una residencia.
            </p>
          </div>
        </div>
      </div>
